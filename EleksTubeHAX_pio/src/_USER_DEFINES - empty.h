...
#define WIFI_SSID      ""       // not needed if WPS is used
#define WIFI_PASSWD    ""   // not needed if WPS is used.  Caution - Hard coded password is stored as clear text in BIN file
