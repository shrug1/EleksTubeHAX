...
bool TFTs::LoadImageIntoBuffer(uint8_t file_index) {
  ...
  bmpFS.close();
  DBG_TFT("Img load time: ");
  DBG_TFT_L(millis() - StartTime);
  return (true);
}
#endif
