...
# target file location: EleksTubeHAX_pio\.pio\libdeps\EleksTubeHax\TFT_eSPI\User_Setup.h
...
ret = shutil.copy2('./src/_USER_DEFINES.h', './.pio/libdeps/EleksTubeHax/TFT_eSPI')
print("Copied {ret}".format(**locals()))
ret2 = shutil.copy2('./src/GLOBAL_DEFINES.h', './.pio/libdeps/EleksTubeHax/TFT_eSPI/User_Setup.h')
...
# env.Execute("copy .\\src\\_USER_DEFINES.h .\\.pio\\libdeps\\EleksTubeHax\\TFT_eSPI")
# env.Execute("copy .\\src\\GLOBAL_DEFINES.h .\\.pio\\libdeps\\EleksTubeHax\\TFT_eSPI\\User_Setup.h")
